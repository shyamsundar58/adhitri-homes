                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <img
                            ...
                            className="rounded-2xl shadow-2xl w-full h-[600px] object-cover hover:scale-[1.02] transition-all duration-500"
                        />
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-[15px] leading-7">
                            ...
                            is a trusted real estate and construction company offering premium
                            apartments, residential plots, individual homes, and commercial
                            developments across Chennai and Tamil Nadu. With over a decade of
                            experience, we focus on quality construction, transparent dealings,
                            timely delivery, and creating long-term value for families and
                            investors.
                        </p>
